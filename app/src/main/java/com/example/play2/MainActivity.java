...
public class MainActivity extends AppCompatActivity implements MediaPlayer.OnPreparedListener, MediaPlayer.OnCompletionListener {
    ...
    // создание полей
    private final String DATA_STREAM = "https://mp3bob.ru/download/muz/Camila_Cabello_feat._Young_Thug_-_Havana_[mp3pulse.su].mp3"; // ссылка на аудио поток
        ...
        try {
            switch (view.getId()) {
                case R.id.btnStream:
                    ...
                    nameAudio = "Camila Cabello feat - 'Young_Thug_Havana'"; // инициализация названия контента
                    break;
                case R.id.btnRAW:
                    ...
                    nameAudio = "КАМАZ - 'ЗАСЫПАЙ'"; // инициализация названия контента
                    break;
                case R.id.btnSD:
